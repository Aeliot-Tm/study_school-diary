...
return [
    ...
    \Core\Form\CSRFHelper::class => [\Core\HTTP\SessionProvider::class, \Core\Security\StringBuilder::class],
    \Core\Form\FormFactory::class => [\Core\Form\CSRFHelper::class],
